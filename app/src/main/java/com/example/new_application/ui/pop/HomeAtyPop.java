...
import com.example.new_application.adapter.HomeZSQAdapter;
import com.example.new_application.adapter.HomeAtyRecyclerAdapter;
...
public class HomeAtyPop extends BasePopupWindow {
    ...
    ArrayList<HomeNoticeEntity> dataList = new ArrayList<>();
    private HomeZSQAdapter homeZSQAdapter;
    private List<Boolean> zsqList = new ArrayList<>();
    public HomeAtyPop(Context context , Activity activity, ArrayList<HomeNoticeEntity> dataList) {
        super(context);
    ...
    private void initZSQRecycler() {
         ...
         * 初始化下方指示器
         */
        homeZSQAdapter = new HomeZSQAdapter(R.layout.home_aty_item_zsq,zsqList, HomeZSQAdapter.SelectorColor.BULE);
        ...
        home_indicator_recycler.setAdapter(homeZSQAdapter);
        ...
        homeZSQAdapter.notifyDataSetChanged();
    }
    ...
    private void initViewPager() {
        ...
        home_aty_viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                HomeNoticeEntity recordsBean = dataList.get(currentItem);
//                app_name_tv.setText(String.format("【%s】",recordsBean.getTitle()));
                app_name_tv.setText("【"+recordsBean.getTheme()+"】");
